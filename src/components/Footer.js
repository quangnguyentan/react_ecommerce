      ...
      <div className="h-[103px] w-full bg-main flex items-center justify-center">
        <div className="w-main flex justify-between items-center">
          ...
          <div className="flex-1 flex items-center ">
            ...
            />
            <div className="rounded-r-full h-[56px] w-[56px] bg-[#F04646] items-center flex">
      ...
      <div className="h-[407px] w-full bg-gray-900 flex items-center justify-center text-white text-[13px]">
        <div className="w-main flex ">
          <div className="flex-2 flex flex-col gap-2">
            <h3 className="mb-[20px] text-[15px] font-medium border-l-[3px] border-main pl-[15px]">
              ABOUT US
            </h3>
            <span>
              <span>Address: </span>
